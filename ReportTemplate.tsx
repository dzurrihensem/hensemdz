        ...
        <div className="flex flex-col w-[65%]">
          ...
          <div className="mt-3">
            ...
            <div className="flex items-center gap-2 mt-1">
               <span className={`px-2 py-0.5 rounded text-[7pt] font-black text-white ${theme.primary} uppercase tracking-tighter`}>
                 {data.kategoriPenyedia}
               </span>
               <span className="text-[8pt] font-bold text-gray-700 uppercase">
                 {data.subKategoriPenyedia && data.subKategoriPenyedia !== 'Pentadbiran' ? `| ${data.subKategoriPenyedia}` : ''}
               </span>
            </div>
            <p className="font-black text-gray-800 uppercase tracking-widest text-[7pt] mt-1 opacity-60">
